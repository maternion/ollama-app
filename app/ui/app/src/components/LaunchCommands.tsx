...
const LAUNCH_COMMANDS: LaunchCommand[] = [
  ...
  },
  {
    ...
    description: "Complete work with ChatGPT (macOS/Windows only)",
    supported: false,
  ...
  },
  {
    ...
    description: "Use Ollama models in Claude Desktop (macOS only)",
...
export default function LaunchCommands() {
  ...
  const renderCommandCard = (item: LaunchCommand) => {
    ...
    return (
    <div key={item.command} className={`w-full text-left ${unsupported ? "opacity-50" : ""}`}>
      <div className="flex items-start gap-4 sm:gap-5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-center gap-2 rounded-xl border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 px-3 py-2">
            ...
            {unsupported ? (
              <span className="text-xs text-neutral-400 dark:text-neutral-600">Unsupported</span>
            ) : (
              <CopyButton
